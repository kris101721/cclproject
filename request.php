<html>
    <head> <title> Pending Request </title> 
    <meta charset="utf-8">
    ...
    if( $total!=0)
    {
        while($result = mysqli_fetch_assoc($data))
        {
            ...
            <tr>
                ...
                <td>" . $result['uname'] . "</td>
                <td>" . $result['email'] . "</td>
                <td><a href='approve.php?rl=$result[roles] & un=$result[uname]' style='color:#fff;    text-decoration:none'>Accept</a></td>
                <td><a href='reject.php?un=$result[uname]' style='color:#fff;    text-decoration:none'>Reject</a></td>
