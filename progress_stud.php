...
<form id="register" class="input-group" action="progress_stud.php" method="POST">
                 
  </select>
  <br><br>
                <!-- <label style="color: white;">Enter the rollno</label>
                <input type="text" style="color: black;" name="rno" class="input-field" placeholder="Roll No Here" required>
                <button type="submit" class="submit-btn" >Get Marks</button> -->
         </form>
